...
const ImpactCard: React.FC<{ icon: string; value: string; label: string }> = ({ icon, value, label }) => (
    <div className="text-center p-6 bg-white rounded-lg shadow-lg">
        <div className="flex items-center justify-center h-16 w-16 rounded-full bg-ocean-blue-100 mx-auto mb-4">
            <ion-icon name={icon} class="text-3xl text-ocean-blue-600" aria-hidden="true"></ion-icon>
        </div>
...
const HomePage: React.FC<HomePageProps> = ({ onNavigate }) => {
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-ocean-blue-50 py-24 sm:py-32" role="banner" aria-label="Hero section">
      ...
      <section className="py-20 bg-white" aria-label="Our mission section">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="w-24 h-1 bg-warm-amber-500 mx-auto mt-4 mb-6" aria-hidden="true"></div>
      ...
      {/* Impact Section */}
      <section className="py-20 bg-gray-50" aria-label="Our impact section">
      ...
      <section className="py-20 bg-ocean-blue-700 text-white" aria-label="Call to action section">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <button onClick={(e) => { e.preventDefault(); onNavigate(Page.ImpactStories); }} className="text-warm-amber-400 hover:text-warm-amber-300 font-semibold text-lg focus:outline-none focus:ring-2 focus:ring-warm-amber-400 rounded px-4 py-2">Learn More &rarr;</button>
          </div>
        </div>
      </section>
      ...
      {/* Latest News Section */}
      <section className="py-20 bg-white" aria-label="Latest news section">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {BLOG_POSTS.map((post, index) => (
              <article key={index} className="bg-white rounded-lg shadow-lg overflow-hidden group" role="article">
                ...
                <div className="p-6">
                  ...
                  <button onClick={() => {}} className="font-semibold text-ocean-blue-600 hover:text-ocean-blue-800 transition duration-300">Read More &rarr;</button>
                </div>
              </article>
            ))}
          </div>
